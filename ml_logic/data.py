...
def Business_day_Tranform(df: pd.DataFrame) -> pd.DataFrame:
    """
    Transform the data to week days
    - back fill all missing values
    """
    # Transform data to business days
    ...
    # Backfill data and remove duplicate
    df = df.drop_duplicates()
    df = df.bfill()(how='any', axis=0)
